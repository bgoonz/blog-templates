...
!((e, t) => {
  ...
  const y = {};
  const m = e => "function" == typeof e && "number" != typeof e.nodeType;
  ...
  const d = (n => {
    ...
    (T = se.setDocument =
      e => {
        ...
        return r != C &&
          ...
          (d.scope = ce(e => (a.appendChild(e).appendChild(C.createElement("div")), "undefined" != typeof e.querySelectorAll &&
          ...
          (d.getById = ce(e => (a.appendChild(e).id = S, !C.getElementsByName || !C.getElementsByName(S).length))),
          d.getById
            ? ((b.filter.ID = e => {
          ...
          (b.find.TAG = d.getElementsByTagName
            ? (e, t) => "undefined" != typeof t.getElementsByTagName
    ...
    ((b = se.selectors =
      {
        ...
        pseudos: {
          ...
          lang: le(n => (V.test(n || "") || se.error("unsupported lang: " + n), n = n.replace(te, ne).toLowerCase(), e => {
            let t;
            do {
              if (
                (t = E
    ...
    (d.attributes &&
      ce(e => (e.innerHTML = "<input/>", e.firstChild.setAttribute("value", ""), "" === e.firstChild.getAttribute("value")))) ||
      fe("value", (e, t, n) => {
  ...
  const V = e => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
  function G() {
  ...
  const ae = (e, t) => "none" === (e = t || e).style.display ||
  ...
  function ct(e, t, n) {
    for (
      let r, i = (ft.tweeners[t] || []).concat(ft.tweeners["*"]), o = 0, a = i.length;
      o < a;
      o++
    )
  ...
  (Wt.href = Tt.href),
    ...
    S.each(["get", "post"], (e, i) => {
      S[i] = (e, t, n, r) => (m(t) && ((r = r || n), (n = t), (t = void 0)), S.ajax(
        S.extend(
  ...
  const Yt = C.jQuery;
  const Qt = C.$;
  return (S.noConflict = e => (C.$ === S && (C.$ = Qt), e && C.jQuery === S && (C.jQuery = Yt), S)),
