...
!((e, t) => {
  ...
  const v = t.flat ? (e) => t.flat.call(e) : (e) => t.concat.apply([], e);
  ...
  const m = {};
  const b = (e) => "function" == typeof e && "number" != typeof e.nodeType;
  const x = (e) => null != e && e === e.window;
  const w = g.document;
          ...
          if (!a) {
            ...
            (a = S(
              ...
              (r = (e, t, n, r, i) => {
                ...
                const h = (N += null == d ? 1 : Math.random() || 0.1);
                const g = p.length;
                for (
                  i && (w = t == T || t || i);
                  l !== g && null != (o = p[l]);
  ...
  const X = (e) => 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
  function Q() {
  ...
  let ie = (e) => E.contains(e.ownerDocument, e);
  const oe = { composed: !0 };
  re.getRootNode &&
    (ie = (e) =>
  ...
  const be = /^key/;
  const xe = /^(?:mouse|pointer|contextmenu|drag|drop)|click/;
  const we = /^([^.]*)(?:\.(.+)|)/;
  function Ce() {
    return !0;
  }
  ...
  function He(e, t, n) {
    for (let r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
  ...
  E.extend({
    ...
    cleanData(e) {
      for (let t, n, r, i = E.event.special, o = 0; void 0 !== (n = e[o]); o++)
        if (X(n)) {
          if ((t = n[Y.expando])) {
            if (t.events)
              for (r in t.events)
    ...
    E.fn.extend({
      ...
      append(...args) {
        return Pe(this, args, function (e) {
          (1 !== this.nodeType &&
            11 !== this.nodeType &&
            9 !== this.nodeType) ||
  ...
  const Ie = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i");
  ...
  const ze = w.createElement("div").style;
  const _e = {};
  function Ue(e) {
    const t = E.cssProps[e] || _e[e];
    return (
      t ||
      (e in ze
        ? e
  ...
  const Ye = /^--/;
  const Ge = { position: "absolute", visibility: "hidden", display: "block" };
    ...
    E.each(["height", "width"], (e, u) => {
      E.cssHooks[u] = {
        ...
        set(e, t, n) {
          let r;
          const i = Re(e);
          const o = !m.scrollboxSize() && "absolute" === i.position;
          const a = (o || n) && "border-box" === E.css(e, "boxSizing", !1, i);
          let s = n ? Ze(e, u, n, a, i) : 0;
          return (
            a &&
              o &&
              (s -= Math.ceil(
        ...
        return (
          (parseFloat(We(e, "marginLeft")) ||
            e.getBoundingClientRect().left -
              Be(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) +
          "px"
        );
    })),
  ...
  (E.proxy = function (e, t) {
    ...
    (E.trim = (e) => (null == e ? "" : (e + "").replace(yt, ""))),
    "function" == typeof define && define.amd && define("jquery", [], () => E);
  const mt = g.jQuery;
  const bt = g.$;
  return (
    (E.noConflict = (e) => (
      g.$ === E && (g.$ = bt), e && g.jQuery === E && (g.jQuery = mt), E
    )),
