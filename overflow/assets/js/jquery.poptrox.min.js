...
!(e => {
  (e.fn.poptrox_disableSelection = function () {
    ...
    x = e(
      s.popupSelector
        ? s.popupSelector
        : `<div class="${s.popupClass}">${s.popupLoaderSelector
        ? `<div class="loader">${s.popupLoaderText}</div>`
        : ""}<div class="pic"></div>${s.popupCaptionSelector ? '<div class="caption"></div>' : ""}${s.popupCloserSelector
    ...
    a
      ...
      .append(
        `<div style="position:absolute;left:0;top:0;width:100%;height:100%;background:${s.overlayColor};opacity:${s.overlayOpacity};filter:alpha(opacity=${100 * s.overlayOpacity});"></div>`
      )
      .hide()
      .on("touchmove", e => {
        return !1;
        ...
        switch (((p = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/)), t.type)) {
          ...
          case "soundcloud":
            (t.object = e(
              ...
              (t.src =
                `//w.soundcloud.com/player/?url=${escape(t.src)}${t.options ? `&${t.options}` : ""}`),
              (t.width = "600"),
              (t.height = "166");
            break;
          case "youtube":
            (t.object = e(
              ...
              (t.src =
                `//www.youtube.com/embed/${p[1]}${t.options ? `?${t.options}` : ""}`),
              (t.width && t.height) ||
          ...
          case "vimeo":
            (t.object = e(
              ...
              (t.src =
                `//player.vimeo.com/video/${p[1]}${t.options ? `?${t.options}` : ""}`),
              (t.width && t.height) ||
                ((t.width = "800"), (t.height = "480"));
            break;
          case "wistia":
            (t.object = e(
              ...
              (t.src =
                `//fast.wistia.net/${p[1]}${t.options ? `?${t.options}` : ""}`),
              (t.width && t.height) ||
                ((t.width = "800"), (t.height = "480"));
            break;
          case "bcove":
