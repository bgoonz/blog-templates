/*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */ !((
          ...
          r !== C &&
            ...
            (d.qsa = K.test(C.querySelectorAll)) &&
              (ce((e) => {
                (a.appendChild(
                  e
                ).innerHTML = `<a id='${k}'></a><select id='${k}-\r\' msallowcapture=''><option selected=''></option></select>`),
    ...
    ((b = se.selectors =
      {
        ...
        pseudos: {
          ...
          checked({ nodeName, checked, selected }) {
            var t = nodeName.toLowerCase();
            return (
              ("input" === t && !!checked) || ("option" === t && !!selected)
            );
          },
      ...
      if (v) {
        n.handler && ((n = (o = n).handler), (i = o.selector)),
          ...
          (a = v.handle) ||
            (a = v.handle =
              function ({ type }) {
                return "undefined" != typeof k && k.event.triggered !== type
      ...
      _default: {
        get({ elem, prop }) {
          ...
          return 1 !== elem.nodeType ||
            (null != elem[prop] && null == elem.style[prop])
            ? elem[prop]
            : (t = k.css(elem, prop, "")) && "auto" !== t
            ? t
            : 0;
        },
        set(e) {
      ...
      ajax(e, t) {
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            (i = (200 <= e && e < 300) || 304 === e),
            n &&
              (s = (({ contents, dataTypes, mimeType, converters }, t, n) => {
                var r;
                var i;
                var o;
                var a;
                ...
                while ("*" === u[0])
                  u.shift(),
                    void 0 === r &&
                      (r = mimeType || t.getResponseHeader("Content-Type"));
                if (r)
                  for (i in s)
                    if (s[i] && s[i].test(r)) {
                      u.unshift(i);
  ...
  (y.cors = !!Xt && "withCredentials" in Xt),
    ...
    k.ajaxPrefilter(({ crossDomain, contents }) => {
    ...
    k.ajaxTransport(
      "script",
      ({ crossDomain, scriptAttrs, scriptCharset, url }) => {
        var r;
        var i;
  ...
  k.ajaxSetup({
    ...
    k.ajaxPrefilter("json jsonp", (e, { jsonpCallback }, n) => {
      var r;
      var i;
      var o;
      var a =
        ...
        return (
          ...
          n.always(() => {
            void 0 === i ? k(C).removeProp(r) : (C[r] = i),
              e[r] && ((e.jsonpCallback = jsonpCallback), Gt.push(r)),
              o && m(i) && i(o[0]),
              (o = i = void 0);
          }),
          "script"
